...
# ax1.annotate("", xy=(14, 0.1), xytext=(23, 0.1), arrowprops=dict(arrowstyle="<|-,head_length=0.15,head_width=0.1", fc="tab:blue", ec="tab:blue", lw=2))
ax1.annotate("", xy=(3.3, 0.1), xytext=(12.5, 0.1), arrowprops=dict(arrowstyle="<|-|>,head_length=0.15,head_width=0.1", fc="tab:blue", ec="tab:blue", lw=2))
# ax1.annotate("", xy=(2.5, 0.1), xytext=(1.9, 0.1), arrowprops=dict(arrowstyle="<|-,head_length=0.15,head_width=0.1", fc="tab:blue", ec="tab:blue", lw=2))
...
# ax1.annotate("", xy=(250, 0.82), xytext=(250, 1.0), arrowprops=dict(arrowstyle="-|>,head_length=0.15,head_width=0.1", fc="tab:red", ec="tab:red", lw=2))
ax1.annotate("", xy=(250, 1.04), xytext=(250, 1.32), arrowprops=dict(arrowstyle="<|-|>,head_length=0.15,head_width=0.1", fc="tab:red", ec="tab:red", lw=2))
# ax1.annotate("", xy=(250, 1.35), xytext=(250, 1.55), arrowprops=dict(arrowstyle="<|-,head_length=0.15,head_width=0.1", fc="tab:red", ec="tab:red", lw=2))
...
ax1.text(25.5, 0.85, "M2", ha="center", va="center", rotation=-90, size=15, zorder=20, color='white', bbox=dict(boxstyle="circle,pad=0.3", fc="tab:grey", ec="white", lw=1))
ax1.text(14.5, 0.99, "M1", ha="center", va="center", rotation=-90, size=15, zorder=20, color='white', bbox=dict(boxstyle="circle,pad=0.3", fc="tab:grey", ec="white", lw=1))
# ax1.annotate("", xy=(45, 0.72), xytext=(60, 0.66), arrowprops=dict(arrowstyle="<|-,head_length=0.15,head_width=0.1", fc="tab:grey", ec="tab:grey", lw=2))
ax1.annotate("", xy=(37, 0.75), xytext=(17.3, 0.95), arrowprops=dict(arrowstyle="<|-|>,head_length=0.15,head_width=0.1", fc="tab:grey", ec="tab:grey", lw=2))
# ax1.annotate("", xy=(250, 1.35), xytext=(250, 1.55), arrowprops=dict(arrowstyle="<|-,head_length=0.15,head_width=0.1", fc="tab:grey", ec="tab:grey", lw=2))
...
ax1.text(1.05, 2.16, r"$3 \times t_\mathrm{1/2}$", ha="left", va="center", rotation=-90, size=20, zorder=20, color='black')
...
tform_list_show = np.array([0.0, 0.30, 0.72, 1.03, 1.44, 1.8, 2.16, 2.4])
...
plt.savefig(fig_dir+"/21_PP7/"+"fig_3.1b"+".pdf", bbox_inches='tight')
